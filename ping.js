...
p.ping("http://vps.poli.fun", function(err, data) {
  // Also display error if err is returned.
  if (err) {
    console.log("error loading resource")
    data = err;
      document.getElementById("ping-vps").innerHTML = data;
  } else {
    document.getElementById("ping-vps").innerHTML = data + " ms (ping is not precise)";
  }
